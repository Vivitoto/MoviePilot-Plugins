...
class SehuatangCaptchaNudgeTest(unittest.TestCase):
    ...
    def test_sehuatang_version_metadata_is_1_1_0_with_six_history_entries(self):
        init_source = PLUGIN_INIT.read_text(encoding="utf-8")
        package = json.loads(PACKAGE_JSON.read_text(encoding="utf-8"))
        sehuatang = package["SehuatangSignin"]

        self.assertIn('plugin_version = "1.1.0"', init_source)
        self.assertEqual(sehuatang["version"], "1.1.0")
        self.assertEqual(
